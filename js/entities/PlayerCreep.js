...
// 			image: "creep2", /*uses this img*/
// 			width: 100, /*32 wide*/
// 			height: 85	, /*64 tall*/
// 			spritewidth: "100",
// 			spriteheight: "85",
// 			getShape: function() {
// 				return (new me.Rect(0, 0, 100, 85)).toPolygon(); /*is a rectangle with these specs*/
// 			}
// 		}]);
...
// 		this.renderable.addAnimation("walk", [0,1,2,3,4], 80); /*adds animation for walking*/
...
// 		if(response.b.type==='EnemyBase') { /*if colliding with player base*/
...
// 		else if(response.b.type==='EnemyCreep') { /*if colliding with player*/
